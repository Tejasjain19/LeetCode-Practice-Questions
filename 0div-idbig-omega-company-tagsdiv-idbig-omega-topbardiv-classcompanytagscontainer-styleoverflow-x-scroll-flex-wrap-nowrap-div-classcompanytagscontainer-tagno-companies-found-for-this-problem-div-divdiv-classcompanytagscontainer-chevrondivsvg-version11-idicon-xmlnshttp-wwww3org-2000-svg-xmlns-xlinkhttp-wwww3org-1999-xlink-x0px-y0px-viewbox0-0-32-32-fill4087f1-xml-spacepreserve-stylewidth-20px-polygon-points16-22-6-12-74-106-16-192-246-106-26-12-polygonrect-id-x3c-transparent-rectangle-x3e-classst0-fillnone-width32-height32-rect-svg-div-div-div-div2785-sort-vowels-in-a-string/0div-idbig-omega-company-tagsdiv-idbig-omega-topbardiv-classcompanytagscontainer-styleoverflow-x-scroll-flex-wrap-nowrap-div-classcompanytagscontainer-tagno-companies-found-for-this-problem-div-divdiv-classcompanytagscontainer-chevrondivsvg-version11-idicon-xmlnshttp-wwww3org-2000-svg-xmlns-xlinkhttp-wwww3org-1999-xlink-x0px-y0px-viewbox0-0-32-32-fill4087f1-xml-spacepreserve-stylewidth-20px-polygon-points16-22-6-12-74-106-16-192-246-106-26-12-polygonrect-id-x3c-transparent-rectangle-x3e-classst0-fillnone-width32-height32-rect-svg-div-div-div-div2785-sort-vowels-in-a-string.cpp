...
public:
    string sortVowels(string inputString) 
    {
        ...
        {
            if(inputString[i] == 'a' || inputString[i] == 'e' || inputString[i] == 'i' || inputString[i] =='o' || inputString[i] == 'u' || inputString[i] == 'A' || inputString[i] == 'E' || inputString[i] == 'O' || inputString[i] == 'I' || inputString[i] == 'U') {
